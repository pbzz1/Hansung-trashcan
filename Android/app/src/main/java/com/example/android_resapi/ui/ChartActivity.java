...
public class ChartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //2. 기간 및 시간 셋팅 -> 초기값은 2023 12월 7일 0시 0분 0초로 셋팅
        //현재 년도, 월, 일, 시간, 분을 정의함
        ...
        textView_Date1.setText(String.format("%d-%d-%d ", 2023 ,12, 7));
        ...
        new GetLog(ChartActivity.this,getLogsURL).execute();
        ...
        startDateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(ChartActivity.this, callbackMethod, year, month, day);
                dialog.show();
            }
        });
        ...
        startTimeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog dialog = new TimePickerDialog(ChartActivity.this, listener, hourOfDay, minute, true);
                dialog.show();
        ...
        endDateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(ChartActivity.this, callbackMethod, year, month, day_cur);
